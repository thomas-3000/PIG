      ...
      options.map(function (d) {
        if (typeof d === 'string') {
          return _react2.default.createElement(
            'label',
            { key: d },
            _react2.default.createElement('input', { type: 'radio', checked: d === value, onChange: _this2.onChange, value: d, name: _this2.id }),
            d
          );
        }
        return _react2.default.createElement(
          'label',
          { key: d.value },
          _react2.default.createElement('input', { type: 'radio', checked: d.value === value, onChange: _this2.onChange, value: d.value, name: _this2.id }),
          d.label || d.value
        );
      })
    );
