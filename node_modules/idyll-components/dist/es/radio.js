      ...
      options.map(function (d) {
        if (typeof d === 'string') {
          return React.createElement(
            'label',
            { key: d },
            React.createElement('input', { type: 'radio', checked: d === value, onChange: _this2.onChange, value: d, name: _this2.id }),
            d
          );
        }
        return React.createElement(
          'label',
          { key: d.value },
          React.createElement('input', { type: 'radio', checked: d.value === value, onChange: _this2.onChange, value: d.value, name: _this2.id }),
          d.label || d.value
        );
      })
    );
